...
import 'package:scrap_it/screens/seller/trashPickup/data/time_slots.dart';
import 'package:scrap_it/screens/seller/trashPickup/data/waste_types.dart';
...
class BookAPickupController extends GetxController {
  ...
  void setPickupLocationAutomatically() async {
    final locationController = Get.find<LocationController>();
    await locationController.getCurrentPosition();
    selectedLocation.value = locationController.userLatLng.value;
    pickUpAddress.value = locationController.userAddress.value;
    update();
  }
